...
A = dict(
  price=595,            # G subscription $/unit/mo (23 Sep: raised from 495 to fund a 30% top-tier VAR share)
...
def run(name, adds, opex, price=None, paid_share=1.0):   # paid_share: fraction of units via cash rev-share channels (0 for Leapfrog-only)
